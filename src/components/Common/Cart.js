...
const Cart = ({ cartItems, increaseQuantity, decreaseQuantity, isPurchase, clients, providers, handlePriceChange, handleQuantityChange, handleRemoveCart, handleSubmit }) => {
